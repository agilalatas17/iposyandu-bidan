...
export default function IntegrasiProgramPage() {
  ...
  const dropdownItems = (integrasiProgramId) => [
    {
      key: 'edit',
      label: (
        <Link
          href={`/ibu-bersalin/${ibu_bersalin_id}/integrasi-program/${integrasiProgramId}/ubah-data`}
        >
          Ubah
        </Link>
      ),
    },
    {
      ...
      label: (
        <Popconfirm
          ...
          onConfirm={() => handleDelete(integrasiProgramId)}
          placement="left"
          okText="Ya"
          cancelText="Batal"
          arrow={false}
  ...
  const PROSES_PERSALINAN_COLUMN = [
    ...
    {
      key: '2',
      title: 'ARV Profilaksis',
      dataIndex: 'arv_profilaksis',
      render: (text) => (text ? text : '-'),
    },
    {
      key: '3',
      title: 'Obat Anti Malaria',
      dataIndex: 'obat_anti_malaria',
      render: (text) => (text ? text : '-'),
    },
    {
      key: '4',
      title: 'Obat Anti TB',
      dataIndex: 'obat_anti_tb',
      render: (text) => (text ? text : '-'),
    },
    {
      key: '5',
  ...
  return (
    <>
      <Row className="pb-7 pt-0">
        <Title level={2}>Integrasi Program Ibu Bersalin</Title>
      ...
      <Row className="pb-4" justify="end">
        <Space>
          <Button
            ...
            href={`/ibu-bersalin/${ibu_bersalin_id}/integrasi-program/tambah-data`}
          >
            Integrasi Program
          </Button>
